...
valid_output_path_1 = 'tests/testdata/read_and_saved_test_raw_data.csv'
...
sample_data = {
    'incident': [1, 2, 3],
    'incident_datetime': ['a', 'b', 'c']
}

pd.DataFrame(sample_data).to_csv(valid_input_path_1, index=False)
